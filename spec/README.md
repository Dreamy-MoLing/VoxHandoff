...
VoxHandoff 是 Hermes 的**第三方 voice-first mobile companion**（v2.1，
...
| 文件 | 内容 |
| --- | --- |
| `PRODUCT.md` | 产品需求、功能、非功能与安全约束（v2.1 基线） |
| `ARCHITECTURE.md` | 技术架构、组件边界、数据流与安全边界（v2.1 基线） |
| `DELIVERY.md` | v2.1 执行顺序（M0/S0/M1-M4）、里程碑、测试矩阵与发布门 |
